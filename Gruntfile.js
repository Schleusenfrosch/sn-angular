...
module.exports = function(grunt) {
	...
	grunt.initConfig({
				...
				files: [
					{
						...
						src: ['formly/directives*.*', 'formly/modules*.*', 'formly/providers*.*', '!.jshintrc'],
						dest: '.tmp/'
					}
				]
			},
				...
				files: [
					{
						expand: true,
						cwd: '<%= formlyConfig.base %>/',
						src: ['formly/directives/formly*.js', 'formly/directives/formly*.html', 'formly/modules*.*', 'formly/providers/*.*', '!.jshintrc'],
						dest: '.tmp/'
					}
				]
			},
		...
		watch: {
			livereload: {
				files: ['<%= formlyConfig.base %>/*/**.{html,js,css}',
						'<%= formlyConfig.base %>/*/*/**.{html,js,css}',
						'<%= formlyConfig.base %>/{,*/,/*}*.{html,js,css}',
				],
				options: {
					livereload: '<%= formlyConfig.livereloadport %>'
